...
use SDF\Lib\WxPay\Data\WxPayOrderQuery;
use SDF\Lib\WxPay\Data\WxPayReverse;
...
class MicroPay
{
	 ...
	 * @return 返回查询接口的结果
	 */
	public function pay($microPayInput,$order_id="")
	{
		//①、提交被扫支付
        $result = WxPayApi::micropay($microPayInput, 120);
		//如果返回成功
        ...
        //支付日志
        file_put_contents('/tmp/wxmicropay'.date('Y-m-d',time()).".log",'订单id:'.$order_id.PHP_EOL.var_export($result,true).PHP_EOL,FILE_APPEND);
